...
const kategoriler = [
  ...
  {
    title: 'Aile Hukuku',
    description: 'Ankara Aile Hukuku Avukatı Av. İsmail Çavuş: Boşanma, velayet, nafaka, mal paylaşımı ve aile içi şiddet konularında profesyonel hukuki destek.',
    slug: 'aile-hukuku',
    color: '#dc2626'
  },
  {
    title: 'İş Hukuku',
    description: 'Ankara İş Hukuku Avukatı Av. İsmail Çavuş: İşçi-işveren uyuşmazlıkları, sözleşmeler, kıdem tazminatı, işe iade davalarında hukuki danışmanlık.',
    slug: 'is-hukuku',
    color: '#dc2626'
  },
  {
    title: 'Ceza Hukuku',
    description: 'Ankara Ceza Hukuku Avukatı Av. İsmail Çavuş: Soruşturma ve kovuşturma süreçlerinde hak savunuculuğu. Ağır ceza, bilişim, uyuşturucu suçlarında destek.',
    slug: 'ceza-hukuku',
    color: '#dc2626'
  },
  {
    title: 'İdare Hukuku',
    description: 'Ankara İdare Hukuku Avukatı Av. İsmail Çavuş: İdari işlemlerin iptali, tam yargı davaları, idari sözleşmeler ve kamu ihale hukuku danışmanlığı.',
    slug: 'idare-hukuku',
    color: '#dc2626'
  },
  {
    title: 'Gayrimenkul Hukuku',
    description: 'Ankara Gayrimenkul Hukuku Avukatı Av. İsmail Çavuş: Tapu, kira, kamulaştırma, imar hukuku ve kat mülkiyeti davalarında uzman hukuki destek.',
    slug: 'gayrimenkul-hukuku',
    color: '#dc2626'
  },
  {
    title: 'Tazminat Hukuku',
    description: 'Ankara Tazminat Hukuku Avukatı Av. İsmail Çavuş: Trafik, iş kazaları, haksız fiil ve sözleşme ihlallerinden doğan tazminat davalarında destek.',
...
export async function seedData() {
  try {
    // Sadece development ortamında log göster
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log('Hesaplama araçları ekleniyor...');
    }
    for (const arac of hesaplamaAraclari) {
      ...
      if (error) {
        if (process.env.NODE_ENV === 'development') {
          console.error('Hesaplama aracı ekleme hatası:', error);
        }
      } else {
        if (process.env.NODE_ENV === 'development') {
