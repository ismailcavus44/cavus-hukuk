...
const AnkaraCezaAvukatiPage = () => {
  ...
  // SEO Schema Data
  const seoSchemaData = {
    pageUrl: 'https://ismailcavus.av.tr/ankara-ceza-avukati',
    serviceName: 'Ankara Ceza Avukatı',
    serviceDescription: 'Ankara\'da ceza hukuku davalarında uzman avukatlar. Ağır ceza, asliye ceza ve soruşturma süreçlerinde profesyonel hukuki destek.',
    serviceType: 'Ceza Hukuku',
    services: [
      { name: 'Ceza Davası Savunması' },
      { name: 'Soruşturma Süreci Danışmanlığı' },
      { name: 'Kovuşturma Süreci Temsili' }
    ],
    areaServed: {
      '@type': 'City',
      name: 'Ankara'
    ...
    businessInfo: {
      ...
      description: 'Ankara\'da ceza hukuku alanında uzman hukuk bürosu',
